...
root.title("Welcome to Hotel Elite")
...
style_button.configure("TButton",font = ("Helvetica",10,"bold"),
   background="crimson")

title_frame = Frame(root, bd=8, bg="cyan", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="HOTEL ELITE", 
                    font=("times new roman", 20, "bold"),bg = "cyan", fg="black", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),
                            bd=8, bg="lightgreen", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", 
                    font=("arial", 15, "bold"),bg = "lightgreen", fg="blue")
...
customer_contact_label = Label(customer_frame, text="Contact", 
                    font=("arial", 15, "bold"),bg = "lightgreen", fg="blue")
customer_contact_label.grid(row = 0, column = 4)
...
customer_contact_entry.grid(row = 0, column=8,padx=50)

#===============Menu===============
menu_frame = Frame(root,bd=8, bg="cyan", relief=GROOVE)
menu_frame.place(x=30,y=170,height=585,width=680)
...
item_frame.place(x=750,y=170,height=300,width=750)
...
order_frame.place(x=750,y=355,height=370,width=750)
...
order_tabel_frame.place(x=20,y=40,height=260,width=680)
